...
import { CALENDAR_URL, WA_FORMACIONES, WA_TRANSFORMATION } from "@/lib/links";
      ...
      <div className="container">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground">
            Cada nivel prepara el siguiente. La mayoría empieza por el ROI Scan.
          </p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-3 gap-6 lg:gap-8 max-w-6xl mx-auto items-stretch">
          ...
          >
            <div className="bg-forest/10 text-forest text-center py-2 text-sm font-semibold">FORMACIÓN</div>
            <div className="p-6 lg:p-8 flex flex-col flex-1">
              <h3 className="text-xl font-bold text-foreground mb-1">Formaciones privadas</h3>
              <p className="text-sm text-muted-foreground mb-6">Personalizadas para tu equipo</p>
              <div className="mb-6">
                <span className="text-lg text-muted-foreground">desde</span>
                <span className="text-4xl font-bold text-foreground ml-2">$500</span>
                <span className="text-muted-foreground ml-1">USD</span>
              </div>
              <ul className="space-y-3 mb-8 flex-1">
                {[
                  "Sesiones a medida para tu equipo",
                  "Foco en automatización e IA aplicada",
                  "Ideal para equipos chicos o áreas puntuales",
                  "Material y plantillas incluidas",
                ].map((item) => (
          ...
          <motion.div
            ...
            className="relative bg-white rounded-2xl border-2 border-orange shadow-xl overflow-hidden flex flex-col md:-mt-3"
          >
