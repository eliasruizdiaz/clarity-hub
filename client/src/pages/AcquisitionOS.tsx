...
import acquisitionStyles from "../acquisition-os.css?inline";
import {
  ArrowDownRight,
  ArrowRight,
  BadgeCheck,
...
export default function AcquisitionOS() {
  useEffect(() => {
    const previousTitle = document.title;
    const routeStyle = document.createElement("style");

    routeStyle.dataset.routeStyles = "acquisition-os";
    routeStyle.textContent = acquisitionStyles;
    document.head.appendChild(routeStyle);
    document.title = "Clarity Acquisition OS · Sistemas de adquisición y conversión";
